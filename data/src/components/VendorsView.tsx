...
import VendorsKanbanView from './VendorsKanbanView'
...
export default function VendorsView({ onRecordClick }: VendorsViewProps) {
  ...
  return (
    <div>
      ...
      {/* View Content */}
      {viewMode === 'table' ? (
        <TableView table="vendors" onRecordClick={onRecordClick} />
      ) : (
        <VendorsKanbanView onRecordClick={onRecordClick} />
      )}
    </div>
  )
}
