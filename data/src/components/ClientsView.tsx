...
export default function ClientsView({ onRecordClick }: ClientsViewProps) {
  ...
  return (
    <div>
      ...
      {/* View Content */}
      {viewMode === 'table' ? (
        <TableView table="clients" onRecordClick={onRecordClick} />
      ) : (
        <KanbanView onRecordClick={onRecordClick} />
      )}
    </div>
  )
}
