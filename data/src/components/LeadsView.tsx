...
export default function LeadsView({ onRecordClick }: LeadsViewProps) {
  ...
  return (
    <div>
      ...
      {/* View Content */}
      {viewMode === 'table' ? (
        <TableView table="leads" onRecordClick={onRecordClick} />
      ) : (
        <LeadsKanbanView onRecordClick={onRecordClick} />
      )}
    </div>
  )
}
