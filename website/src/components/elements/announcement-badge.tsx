  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === 'normal' &&
          'bg-oxblood/5 text-oxblood hover:bg-oxblood/10 dark:bg-white/5 dark:text-coral dark:inset-ring-1 dark:inset-ring-white/5 dark:hover:bg-white/10',
        variant === 'overlay' &&
    ...
    >
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'bg-oxblood/20 dark:bg-white/10',
      ...
      <span
        className={clsx(
          ...
          variant === 'normal' && 'text-oxblood dark:text-coral',
        )}
      >
