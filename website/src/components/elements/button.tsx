...
export function SoftButton({
  ...
  return (
    <button
      type={type}
      className={clsx(
        'inline-flex shrink-0 items-center justify-center gap-1 rounded-full bg-oxblood/10 text-sm/7 font-medium text-oxblood hover:bg-oxblood/15 dark:bg-white/10 dark:text-coral dark:hover:bg-white/20',
        sizes[size],
        className,
      )}
      {...props}
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        color === 'dark/light' && 'text-oxblood hover:bg-oxblood/10 dark:text-coral dark:hover:bg-white/10',
