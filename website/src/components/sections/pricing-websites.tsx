          ...
          {WEBSITE_OPTIONS.map((option) => (
            ...
            >
              <div className="relative z-10 flex h-full flex-col">
                ...
                <div className="mt-6">
                  {option.popular ? (
                    <ButtonLink href={`/contact?service=websites&option=${option.id}`} size="md" className="w-full justify-center">
                      Get started
                    </ButtonLink>
                  ) : (
                    <SoftButtonLink href={`/contact?service=websites&option=${option.id}`} size="md" className="w-full justify-center">
                      Get started
                    </SoftButtonLink>
                  )}
                </div>
            ...
            <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex-1">
                ...
                <h3 className="mt-3 text-lg font-medium tracking-tight text-oxblood dark:text-ember">
                  Want ongoing website optimization plus the complete marketing package?
                </h3>
                <p className="mt-2 text-sm/6 text-oxblood/70 dark:text-coral/70">
                  Get website development plus brand strategy, paid ads, search marketing, and dedicated team support.
                </p>
