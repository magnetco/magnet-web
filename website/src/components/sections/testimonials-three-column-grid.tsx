...
export function Testimonial({
  ...
  return (
    <figure
      className={clsx(
        'flex flex-col justify-between gap-10 rounded-md bg-olive-950/2.5 p-6 text-sm/7 text-oxblood dark:text-coral',
        className,
      )}
      {...props}
    >
      ...
      <figcaption className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-oxblood dark:text-coral">{byline}</p>
        </div>
      </figcaption>
    </figure>
  )
