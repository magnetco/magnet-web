    ...
    <section className={clsx('py-16', className)} {...props}>
      <Container>
        ...
        <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-ember/10 px-4 py-2 text-sm font-medium text-ember">
          ...
          Services can be combined for a comprehensive search strategy
        </div>
          ...
          {SEARCH_OPTIONS.map((option) => (
            ...
            >
              <div className="relative z-10 flex h-full flex-col">
                ...
                {/* Description */}
                <p className="mt-3 text-sm/6 text-oxblood/70 dark:text-coral/70">{option.description}</p>
                ...
                <div className="mt-5">
                  {option.popular ? (
                    ...
                    <SoftButtonLink href={`/contact?service=search-marketing&option=${option.id}`} size="sm" className="w-full justify-center">
                      Get started
                    </SoftButtonLink>
                  )}
                </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="text-lg font-medium text-oxblood dark:text-ember">
                Full Search Marketing Program
              </h3>
              <p className="mt-1 text-sm text-oxblood/70 dark:text-coral/70">
                Combine all four services for maximum impact. Get a 15% discount on the combined monthly rate.
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                <div className="text-sm text-oxblood/60 line-through dark:text-coral/60">$13,000/mo</div>
                <div className="text-xl font-medium text-ember">$11,000/mo</div>
              </div>
              <ButtonLink href="/contact?service=search-marketing" size="md">
                Get started
              </ButtonLink>
            </div>
          </div>
            ...
            <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex-1">
                ...
                <h3 className="mt-3 text-lg font-medium tracking-tight text-oxblood dark:text-ember">
                  Want search marketing plus the complete growth package?
                </h3>
                <p className="mt-2 text-sm/6 text-oxblood/70 dark:text-coral/70">
                  Get all search services plus brand strategy, website development, paid ads, and dedicated team support.
                </p>
