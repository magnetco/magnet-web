---
name: Codebase Architecture Diagram
overview: "Create a visual Mermaid diagram showing the relationships between the four main parts of the magnet-web codebase: context, data, studio, and website."
todos: []
---

# Magnet-Web Codebase Architecture

Here's a Mermaid diagram showing how the four parts of your codebase are interrelated:
